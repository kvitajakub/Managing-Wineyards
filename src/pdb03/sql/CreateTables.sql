-- For temporal data assign ID manually
DROP TABLE Spatial_object;
DROP TABLE Wine_grower;
DROP TABLE Wine_type;
DROP SEQUENCE Wine_grower_seq;
DROP SEQUENCE Wine_type_seq;
DROP SEQUENCE Spatial_object_seq;
DELETE FROM USER_SDO_GEOM_METADATA WHERE TABLE_NAME='SPATIAL_OBJECT' AND COLUMN_NAME='GEOMETRY';
